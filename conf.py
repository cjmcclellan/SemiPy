# -*- coding: utf-8 -*-
#
# SemiPy documentation build configuration file, created by
...
project = u'SemiPy'
copyright = u'2020, Connor McClellan'
author = u'Connor McClellan'
...
latex_documents = [
    (master_doc, 'SemiPy.tex', u'SemiPy Documentation',
     u'Connor McClellan', 'manual'),
]
