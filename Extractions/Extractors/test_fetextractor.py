...
class TestFETExtractor(unittest.TestCase):
    ...
    def test_fetextraction(self):
        ...
        idvd_path = '/home/connor/Documents/Stanford_Projects/Extractions/fetextraction/Extractions/SampleData/FETExampleData/WSe2_Sample_4_Id_Vd.txt'
        idvg_path = '/home/connor/Documents/Stanford_Projects/Extractions/fetextraction/Extractions/SampleData/FETExampleData/WSe2_Sample_4_Id_Vg.txt'
